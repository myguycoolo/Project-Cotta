...
function webapp() {
    ...
    just_task_1.task('ts', just_task_1.parallel('ts:esm'));
    ...
    just_task_1.task('webpack', tasks_1.webpackTask());
    just_task_1.task('webpack:watch', tasks_1.webpackDevServerTask());
    just_task_1.task('build', just_task_1.series('ts', 'webpack'));
    just_task_1.task('test', just_task_1.series('jest'));
    just_task_1.task('start', just_task_1.series('webpack:watch'));
